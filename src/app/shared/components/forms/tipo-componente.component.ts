...
export class TipoComponenteFormComponent implements OnInit {
  ...
  readonly dialogRef = inject(MatDialogRef<TipoComponenteFormComponent>);
  ...
  onSubmit() {
    ...
    if (this.form.valid) {
      ...
      if (this.esActualizar()) {
        this.tipoComponenteService.actualizar(formData.id, formData).subscribe({
          next: (response) => {
        ...
        this.tipoComponenteService.crear(formData).subscribe({
          next: (response) => {
