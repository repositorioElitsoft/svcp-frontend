...
@Component({
  selector: 'app-tipo-producto-tipo-componente-create-form',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
...
export class TipoProductoTipoComponenteFormComponent implements OnInit {
  form!: FormGroup;
  isLoading = false; // Variable para controlar el estado de carga

  readonly dialogRef = inject(MatDialogRef<TipoProductoTipoComponenteFormComponent>);
