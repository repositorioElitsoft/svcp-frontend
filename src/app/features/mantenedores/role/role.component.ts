...
export class RoleComponent implements OnInit {
  ...
  obtenerDatos(sortField: string = 'id', sortDirection: string = 'asc', optionalFilter: any = {}) {
    ...
    this.roleService.buscarFiltrado(mandatoryFilter).subscribe(
  ...
  eliminar(selectedItems: Role[]) {
    ...
    dialogRef.afterClosed().subscribe(confirmado => {
      if (confirmado) {
        ...
        this.roleService.borrarTodos(ids).subscribe({
          next: () => {
  ...
  onDeleteSingleSelected(id: string) {
    ...
    // Obtener las traducciones
    const titulo = this.translate.instant('alertas.eliminacionIndividualTitulo') + ' ' + this.translate.instant('mantenedores.role.titulo');
    ...
    dialogRef.afterClosed().subscribe(confirmado => {
      if (confirmado) {
        ...
        this.roleService.borrar(Number(id)).subscribe({
          next: () => {
