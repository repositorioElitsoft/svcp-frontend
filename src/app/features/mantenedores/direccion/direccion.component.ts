...
export class DireccionComponent implements OnInit {
  ...
  exportarExcel() {
    ...
    this.direccionService.buscarTodos().subscribe((data: any[]) => {
  ...
  obtenerDatos(sortField: string = 'id', sortDirection: string = 'asc', optionalFilter: any = {}) {
    ...
    this.direccionService.buscarFiltrado(mandatoryFilter).subscribe((data: PagedResponse<Direccion[]>) => {
  ...
  /*********************************** CRUD   - DELETE ***********************************/
  eliminar(selectedItems: Direccion[]) {
    ...
    dialogRef.afterClosed().subscribe(confirmado => {
      if (confirmado) {
        ...
        this.direccionService.borrarTodos(ids).subscribe({
          next: () => {
  ...
  onDeleteSingleSelected(id: string) {
    ...
    // Obtener las traducciones
    const titulo = this.translate.instant('alertas.eliminacionIndividualTitulo') + ' ' + this.translate.instant('mantenedores.direccion.titulo');
