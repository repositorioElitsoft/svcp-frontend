...
import { TipoServicioFormComponent } from "../../../shared/components/forms/tipo-servicio.component";
...
export class TipoServicioComponent implements OnInit {
  ...
  exportarExcel(sortField: string = 'id', sortDirection: string = 'asc', optionalFilter: any = {}) {
    const handleExport = (dataArray: any[], translationBase: string) => {
      ...
      if (translationBase === 'mantenedores.tipoServicio') {
    ...
    if (this.selectedData && Array.isArray(this.selectedData) && this.selectedData.length > 0) {
      ...
      handleExport(this.selectedData, 'mantenedores.tipoServicio');
      ...
      this.tipoServicioService.buscarFiltrado(filtros).subscribe(
        (response: any) => {
          ...
          handleExport(apiData, 'mantenedores.tipoServicio');
